...
@Preview
@Composable
fun Preview_DydxReceiptExpectedPriceView() {
    DydxThemedPreviewSurface {
        DydxReceiptExpectedPriceView.Content(
            Modifier,
...
object DydxReceiptExpectedPriceView : DydxReceiptItemView(), DydxComponent {
    @Composable
    override fun Content(modifier: Modifier) {
        val viewModel: DydxReceiptExpectedPriceViewModel = hiltViewModel()

...
import exchange.dydx.trading.feature.portfolio.orderdetails.DydxOrderDetailsView.Item
import exchange.dydx.trading.feature.shared.views.HeaderViewCloseBotton
import java.util.UUID

@Preview
@Composable
fun Preview_DydxFundingDetailsView() {
    DydxThemedPreviewSurface {
        DydxFundingDetailsView.Content(Modifier, DydxFundingDetailsView.ViewState.preview)
    }
}

object DydxFundingDetailsView : DydxComponent {
    data class Item(
    ...
    data class ViewState(
        ...
        val status: DydxPortfolioFundingItemView.FundingStatus = DydxPortfolioFundingItemView.FundingStatus.earned,
    ...
    override fun Content(modifier: Modifier) {
        val viewModel: DydxFundingDetailsViewModel = hiltViewModel()

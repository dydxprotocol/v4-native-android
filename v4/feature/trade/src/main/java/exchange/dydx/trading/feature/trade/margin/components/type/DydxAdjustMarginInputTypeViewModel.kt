    ...
    private fun createViewState(
        ...
        return DydxAdjustMarginInputTypeView.ViewState(
            ...
            direction = when (adjustMarginInput.type) {
                IsolatedMarginAdjustmentType.Add -> DydxAdjustMarginInputTypeView.MarginDirection.Add
                IsolatedMarginAdjustmentType.Remove -> DydxAdjustMarginInputTypeView.MarginDirection.Remove
            },
            marginDirectionAction = { direction ->
                abacusStateManager.adjustIsolatedMargin(
                    data = when (direction) {
                        DydxAdjustMarginInputTypeView.MarginDirection.Add -> IsolatedMarginAdjustmentType.Add
                        DydxAdjustMarginInputTypeView.MarginDirection.Remove -> IsolatedMarginAdjustmentType.Remove
                    }.name,

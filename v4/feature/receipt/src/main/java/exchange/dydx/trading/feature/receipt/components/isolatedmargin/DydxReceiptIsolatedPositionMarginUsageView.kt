...
fun Preview_DydxReceiptMarginUsageView() {
    DydxThemedPreviewSurface {
        DydxReceiptIsolatedPositionMarginUsageView.Content(Modifier, DydxReceiptIsolatedPositionMarginUsageView.ViewState.preview)
    }
}

object DydxReceiptIsolatedPositionMarginUsageView : DydxComponent {
    ...
    override fun Content(modifier: Modifier) {
        val viewModel: DydxReceiptIsolatedPositionMarginUsageViewModel = hiltViewModel()

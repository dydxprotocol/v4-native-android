...
@Preview
@Composable
fun Preview_DydxReceiptBuyingPowerView() {
    DydxThemedPreviewSurface {
        DydxReceiptBuyingPowerView.Content(Modifier, DydxReceiptBuyingPowerView.ViewState.preview)
    }
}

object DydxReceiptBuyingPowerView : DydxComponent {
    ...
    override fun Content(modifier: Modifier) {
        val viewModel: DydxReceiptBuyingPowerViewModel = hiltViewModel()

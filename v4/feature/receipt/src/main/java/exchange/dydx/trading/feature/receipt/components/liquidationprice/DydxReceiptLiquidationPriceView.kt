...
object DydxReceiptLiquidationPriceView : DydxComponent {
    ...
    override fun Content(modifier: Modifier) {
        val viewModel: DydxReceiptLiquidationPriceViewModel = hiltViewModel()
